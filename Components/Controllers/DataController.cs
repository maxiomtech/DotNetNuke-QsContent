...
namespace InspectorIT.QSContent.Components.Controllers
{
    /// <summary>
    ...
    public class DataController
    {
        ...
        public static void AddCheck(int moduleId, string querystring,bool hideMatch, bool serverSide, int checkModuleId, int userId)
        {
            ...
            DataProvider.Instance()
                        .ExecuteNonQuery(DataPrefix + "UpdateCheck", 0, moduleId, querystring, hideMatch, serverSide,
                                         checkModuleId, userId);
            ClearCache(moduleId);
        }
        ...
        public static void UpdateCheck(int id, int moduleId, string querystring, bool hideMatch, bool serverSide, int checkModuleId, int userId)
        {
            DataProvider.Instance().ExecuteNonQuery(DataPrefix + "UpdateCheck", id, moduleId, querystring, hideMatch, serverSide, checkModuleId, userId);
            ClearCache(moduleId);
        }
    }
}