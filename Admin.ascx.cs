...
namespace InspectorIT.QSContent
{
    ...
    public partial class Admin : PortalModuleBase
    {
        ...
        //{
        //    //DataController.AddCheck(ModuleId, txtQuerystring.Text, cbHideMatch.Checked, cbServerSideCheck.Checked, Convert.ToInt32(ddlModules.SelectedValue), UserId);
        //    //BindItems();
        //    //txtQuerystring.Text = "";
        ...
        {
            get { return VirtualPathUtility.ToAbsolute(ControlPath.Replace("/views", "") + "WebService.asmx"); }
        }
    }
}